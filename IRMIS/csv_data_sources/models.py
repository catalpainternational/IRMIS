...
class CsvDataSource(models.Model):
    ...
    columns = ArrayField(base_field=models.TextField(), help_text='The column names present in the csv')


class CsvData(models.Model):
    source = models.ForeignKey(CsvDataSource, on_delete=models.CASCADE, related_name='rows')
