...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--filename', required=True, help='The shapefile to import into PostgreSQL')
        parser.add_argument('--table', required=True, choices=getattr(settings, 'FEATURE_TABLES', []), help='The table name of the feature to import')
