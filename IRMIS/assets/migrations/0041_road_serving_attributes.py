...
class Migration(migrations.Migration):
    ...
    def insertData(apps, schema_editor):
        ...
        FACILITY_TYPE_CHOICES = [
            ("1", _("Health facility")),
            ("2", _("School")),
            ("3", _("Police/security station")),
            ("4", _("Fire station")),
            ("5", _("Recreational area")),
        ]
        # These are present in the RRMPIS shapefile data - but they are free-form text, not codified
        ...
        CONNECTION_TYPE_CHOICES = [
            ("1", _("Connects municipalities")),
            ("2", _("Connects Dili to municipal centers")),
            ("3", _("Connects administrative posts")),
            ("4", _("Connects to land border")),
            ("5", _("Connects to seaport")),
            ("6", _("Connects to airport")),
        ]
