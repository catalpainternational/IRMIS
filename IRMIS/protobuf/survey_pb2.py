...
_REPORT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="road_code",
            full_name="assets.Report.road_code",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="report_chainage_start",
            full_name="assets.Report.report_chainage_start",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="report_chainage_end",
            full_name="assets.Report.report_chainage_end",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="counts",
            full_name="assets.Report.counts",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="percentages",
            full_name="assets.Report.percentages",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
...
_TABLEENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="chainage_start",
            full_name="assets.TableEntry.chainage_start",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="chainage_end",
            full_name="assets.TableEntry.chainage_end",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="survey_id",
            full_name="assets.TableEntry.survey_id",
            index=3,
            number=4,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="date_surveyed",
            full_name="assets.TableEntry.date_surveyed",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="added_by",
            full_name="assets.TableEntry.added_by",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
