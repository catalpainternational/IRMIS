...
_ROAD = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="asset_class",
            full_name="assets.Road.asset_class",
            index=4,
            number=10,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="assets.Road.asset_condition",
            index=13,
            number=9,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="total_width",
            full_name="assets.Road.total_width",
            index=16,
            number=29,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="number_lanes",
            full_name="assets.Road.number_lanes",
            index=25,
            number=27,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="assets.Road.rainfall_maximum",
            index=26,
            number=28,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="assets.Road.rainfall_minimum",
            index=27,
            number=38,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="assets.Road.construction_year",
            index=28,
            number=30,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="population",
            full_name="assets.Road.population",
            index=29,
            number=31,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="assets.Road.served_facilities",
            index=31,
            number=33,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="assets.Road.served_economic_areas",
            index=32,
            number=34,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="assets.Road.served_connection_types",
            index=33,
            number=35,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="assets.Road.inventory_media",
            index=34,
            number=36,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="survey_media",
            full_name="assets.Road.survey_media",
            index=35,
            number=37,
            type=11,
            cpp_type=10,
...
_ROAD.fields_by_name["inventory_media"].message_type = media__pb2._MEDIA
_ROAD.fields_by_name["survey_media"].message_type = media__pb2._MEDIA
